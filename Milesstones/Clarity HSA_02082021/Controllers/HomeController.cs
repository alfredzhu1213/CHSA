...
namespace Clarity_HSA.Controllers
{
    ...
    {
        Tamir.SharpSsh.Sftp Alegeus_ftp = new Tamir.SharpSsh.Sftp("ftp.wealthcareadmin.com", "f", "xxxx");
        Tamir.SharpSsh.Sftp Clarity_ftp = new Tamir.SharpSsh.Sftp("ftp.flexaccount.com", "f", "xxxx");
